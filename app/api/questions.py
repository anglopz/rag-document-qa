...
question_input = ns.model(
    "QuestionInput",
    {
        "question": fields.String(
            required=True, description="The question to ask", example="What is the statute of limitations?"
        ),
...
class QuestionResource(Resource):
    ...
    @ns.doc("ask_question")
    @ns.expect(question_input, validate=True)
    ...
    def post(self):
        ...
        # Run extractive QA on each retrieved chunk
